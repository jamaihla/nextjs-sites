    ...
    return (
        ...
        <div className="flex flex-col lg:flex-row lg:justify-start items-center lg:items-start">
            <div className="w-full sm:w-72 lg:w-3/12">
                {/*<img className="lg:w-4/6 mb-6" src="img/logo.svg" alt="" />*/}
            ...
            <nav className="hidden lg:block justify-center text-center lg:text-left lg:w-3/12 mt-14 lg:mt-1">
                <ul>
                    <li className="font-main font-semibold text-base text-lightblack mb-6">Home</li>
                    <li className="font-main text-base text-lightblack mb-6">About Us</li>
                    <li className="font-main text-base text-lightblack mb-6">Our Products</li>
                    <li className="font-main text-base text-lightblack mb-6">Contact Us</li>
                </ul>
            </nav>
            <div className="w-36 sm:w-72 flex flex-col lg:w-3/12 mt-10 lg:mt-1 justify-around lg:justify-items-stretch items-center lg:items-start">
                ...
                <div className="w-full lg:w-48 flex justify-between lg:justify-between items-center lg:items-start">
                    <div className="w-6 sm:w-12 lg:w-6"><a href="#"><img src="img/001-facebook.svg" alt="" /></a></div>
                    <div className="w-6 sm:w-12 lg:w-6"><a href="#"><img src="img/003-twitter.svg" alt="" /></a></div>
                    <div className="w-6 sm:w-12 lg:w-6"><a href="#"><img src="img/002-instagram.svg" alt="" /></a></div>
                </div>
            </div>
