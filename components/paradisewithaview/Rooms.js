            ...
            <div className="desktop:flex">
                <div className={styles.card}>
                    ...
                    <div className="px-8">
                        ...
                        <div className="desktop:flex desktop:justify-between desktop:mt-16 xxl:mt-24 items-center">
                            <span className="inline-block font-sofia text-darkseagreen text-sm tablet:text-2xl desktop:text-xl font-semibold py-8 desktop:p-0 xxl:p-0">$245 a night</span>
                            <button className="bg-redviolet w-full text-sm xxl:text-xl tablet:w-1/3 desktop:w-1/2 xxl:w-1/3 mx-auto desktop:mx-0 xxl:mx-0 flex justify-center text-offwhite px-2 py-3 items-center rounded-md">
                ...
                <div className={styles.card}>
                    ...
                    <div className="px-8">
                        ...
                        <span className="block font-sofia text-lightblack text-sm tablet:text-base">One Queen Sofa Bed</span>
                        <div className="desktop:flex desktop:justify-between desktop:mt-16 xxl:mt-24 items-center">
                            <span className="inline-block font-sofia text-darkseagreen text-sm tablet:text-2xl desktop:text-xl font-semibold py-8 desktop:p-0 xxl:p-0">$350 a night</span>
                            <button className="bg-redviolet w-full text-sm xxl:text-xl tablet:w-1/3 desktop:w-1/2 xxl:w-1/3 mx-auto desktop:mx-0 xxl:mx-0 flex justify-center text-offwhite px-2 py-3 items-center rounded-md">
                                <span className="">Reserve</span>
                                <img className="ml-2" src="paradisewithaview/right-arrow.svg" alt="right-arrow" />
                            </button>
                ...
                <div className={styles.card}>
                    ...
                    <div className="px-8">
                        ...
                        <span className="block font-sofia text-lightblack text-sm tablet:text-base">One Queen Bed</span>
                        <span className="block font-sofia text-lightblack text-sm tablet:text-base">One Queen Sofa Bed</span>
                        <div className="desktop:flex desktop:justify-between desktop:mt-24 xxl:mt-24 items-center">
                            <span className="inline-block font-sofia text-darkseagreen text-sm tablet:text-2xl desktop:text-xl font-semibold py-8 desktop:p-0 xxl:p-0">$750 a night</span>
                            <button className="bg-redviolet w-full text-sm xxl:text-xl tablet:w-1/3 desktop:w-1/2 xxl:w-1/3 mx-auto desktop:mx-0 xxl:mx-0 flex justify-center text-offwhite px-2 py-3 items-center rounded-md">
                                <span className="">Reserve</span>
                                <img className="ml-2" src="paradisewithaview/right-arrow.svg" alt="right-arrow" />
                            </button>
